...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head runat="server"><title>MySql Exam</title><style type="text/css">
        #countdown1
        {
...
<BR>
<%--<TABLE><TBODY>
<TR><TD><INPUT class="b2t" onclick=InitializeTimer(form) type=button value="Start the Timer"></TD>
<TD><INPUT class="b3t" onclick="history.go(0)" type=button value="  Stop  ">
</TD></TR>
</TBODY></TABLE>--%>
