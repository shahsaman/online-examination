...
&nbsp;<br />
    Right Answer :&nbsp;
    <asp:Label ID="Label3" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 2 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label6" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 3 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label9" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 4 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label12" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 5 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label15" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 6 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label18" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 7 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label21" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 8 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label24" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 9 ::<asp:Label ID="Label25" runat="server" Text="Label"></asp:Label>
    <br />
   Option Selected :
    <asp:Label ID="Label26" runat="server" Text="Label"></asp:Label>
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label27" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 10 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label30" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 11 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label33" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 12 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label36" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 13 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label39" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 14 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label42" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 15 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label45" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 16 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label48" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 17 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label51" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 18 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label54" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 19 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label57" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
    <br />
    <br />
    Question 20 : 
...
&nbsp;<br />
    Right Answer :
    <asp:Label ID="Label60" runat="server" Text="Label" BackColor="#33CC33"></asp:Label>
